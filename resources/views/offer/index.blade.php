                        ...
                        @foreach ($results as $offer)
                            <div class="contenedor">
                                <section class="contenedor-izquierda">
                                    ...
                                    @foreach ($vacancies[$offer->id] as $vacancy)
                                        <section class="contenedor-derecha">
                                            <li class="oferta-item"><a>Vacants: {{ $vacancy->number_vacancies_applied }}</a>
                                            </li>
                                            ...
                                            <section class="boton">
                                                <a href="{{ route('postulation', ['oferta' => $offer]) }}"><button
                                                        class="botonUnico">Postularme</button></a>
                                            </section>
                                        </section>
                                    @endforeach
                                </section>
        ...
        <div class="container2">
            <section class="contenedor1">
                ...
                <section class="segundo">
                    ...
                    <input type="date" id="fecha_pucblicacion" name="fecha_pucblicacion" class="select"
                        onchange="filterOffers()"><br><br><br>
                </section>
        </div>
    </div>
@endsection
